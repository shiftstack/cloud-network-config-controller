...
func init() {
	...
	flag.IntVar(&platformCfg.OpenStackMaxAllowedAddressPairs, "platform-os-max-allowed-address-pairs", 10, "Maximum number of allowed address pairs per OpenStack port. Overrides the Neutron default of 10.")
	flag.Parse()
